...
*Article available as a Jupyter Notebook: [:material-notebook-outline: `SuchTree_2.ipynb`](../../assets/notebooks/SuchTree_2.ipynb){ download="SuchTree_2.ipynb" }*
...
![dueling trees](../../assets/dueling_trees.png){ .nb-fig }
...
![Figure 0](SuchTree_2_files/fig_000.png){ .nb-fig }
...
![Figure 1](SuchTree_2_files/fig_001.png){ .nb-fig }
...
![Figure 2](SuchTree_2_files/fig_002.png){ .nb-fig }
...
![](../../assets/clade_26971.svg){ .nb-fig width="500" }
