...
- eisenlab
- research
description: Use a 3D printer to make your own gel combes. Here's the code to design
  your own.
publish: true
---
...
![Original and 3D printed gel combs](../../assets/gel_combs_ultimaker.jpg){ .nb-fig }
...
The 3D printer cost €1194.00 ($1524.62), which is less than the laptop
