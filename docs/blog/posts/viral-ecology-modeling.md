...
- ryneches
date: 2024-03-06
description: A workshop with David Demory on mathematical modeling of the community
  dynamics of viruses in Python
tags:
- python
- modeling
- math
...
![SV model](../../assets/sv_model.png){ .nb-fig }
...
![SIV model](../../assets/siv_model.png){ .nb-fig }
...
![R0 vs beta](../../assets/r0_vs_beta.png){ .nb-fig }
...
![SIV model at critical R0](../../assets/siv_model_critical_r0.png){ .nb-fig }
...
![R0 vs lysis rate](../../assets/r0_vs_lysis.png){ .nb-fig }
...
![SIV interactive widgets](../../assets/siv_ipywidgets.png){ .nb-fig }
