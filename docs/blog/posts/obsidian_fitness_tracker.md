...
3. In Templater settings, set **Template folder** to `Templates/` and **Script files folder** to `Templates/Scripts/`.
4. Enable **Trigger Templater on new file creation** in Templater settings.
5. Open `Fitness/Workouts.md`. The three bold summary lines at the top will populate once you have workout notes in the folder.
## Designing workouts
...
3. When finished, press **Finish Workout**. The script:
