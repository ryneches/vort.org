...
*Article available as a Jupyter Notebook: [:material-notebook-outline: `SuchTree_1.ipynb`](../../assets/notebooks/SuchTree_1.ipynb){ download="SuchTree_1.ipynb" }*
...
![Figure 0](SuchTree_1_files/fig_000.png){ .nb-fig }
...
![Figure 1](SuchTree_1_files/fig_001.png){ .nb-fig }
...
![Figure 2](SuchTree_1_files/fig_002.png){ .nb-fig }
...
![Figure 3](SuchTree_1_files/fig_003.png){ .nb-fig }
...
![Figure 4](SuchTree_1_files/fig_004.png){ .nb-fig }
